...
<head>
    ...
    <link rel="icon" type="image/png" href="images/home/iconggpc.png">
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <!--header_top-->
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logoggpc.png" alt="" /></a>
            </div> 
          </div>
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                ...
                <?php }else{ ?> 
                <li><a data-target="#smyModal" data-toggle="modal"  href=""><i class="fa fa-lock"></i> Sign in</a></li>
              <?php } ?>
              </ul>
            </div>
          </div>
    ...
    <!-- ADS -->
<!-- <div class="ads">
  <img src="images/home/adssss.png" alt="">
</div> -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-2">
            ...
            <a href="<?php echo web_root?>"><img src="images/home/logofooter.png" alt="" /></a>
